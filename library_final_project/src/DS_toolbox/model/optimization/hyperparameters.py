...
def tuning(model, random_grid, scoring, X, y):
    """
    This function finds the best combination of hyperparameter values
    from a random grid of values for the model.
    Parameters:
    --------------
    - model: model to optimize hyperparameters
    - random_grid: grid of values for RandomizedSearch to try. Look at sklearn
    RandomizedSearchCV for more info
    - scoring: str score identifier from sklearn to optimize the
    hyperparameters
