...
def CV_model(X, y, kf, model, metric, the_greater_the_better=True):
    """This function allows for a cross validationtraining returning all the
    important information of the best fold training.
    ...
    - the_greater_the_better: boolean parameter to indicate if the score
